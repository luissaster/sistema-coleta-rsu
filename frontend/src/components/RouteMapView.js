...
const RouteMapView = ({ show, onHide, route, collectionPoints = [] }) => {
  ...
  useEffect(() => {
    if (route && show) {
      ...
      console.log('Geometria recebida:', route.geometry);
      console.log('Tipo:', typeof route.geometry);
      ...
      if (route.geometry && route.geometry.coordinates) {
        ...
        if (route.geometry.startsWith('{')) {
          try {
            ...
            const points = geom.coordinates.map(coord => [coord[1], coord[0]]);
            setRoutePoints(points);
        ...
        else if (route.geometry.includes('LINESTRING') || route.geometry.startsWith('SRID')) {
          ...
          <>
            ...
            <div className="mb-3 p-3 bg-light rounded">
              <div className="row">
                ...
                <div className="col-md-3">
                  ...
                  <div className="fw-bold" style={{ color: getStatusColor(route.status) }}>
            ...
            <div className="mt-3 d-flex justify-content-center gap-4">
              <div className="d-flex align-items-center">
                <div style={{ width: '20px', height: '4px', backgroundColor: getStatusColor(route.status), marginRight: '8px' }}></div>
                <small>Rota</small>
              </div>
              <div className="d-flex align-items-center">
                <div style={{ width: '20px', height: '20px', backgroundColor: 'green', borderRadius: '50%', marginRight: '8px' }}></div>
                <small>Início</small>
              </div>
              <div className="d-flex align-items-center">
                <div style={{ width: '20px', height: '20px', backgroundColor: 'red', borderRadius: '50%', marginRight: '8px' }}></div>
                <small>Fim</small>
              </div>
              <div className="d-flex align-items-center">
                <img 
